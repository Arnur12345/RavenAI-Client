...
import { Calendar, Clock, Users, Mic, Search, Filter, Plus, Eye, Download, Trash2 } from 'lucide-react'
  ...
  const fetchMeetings = async () => {
    try {
      ...
      const transformedMeetings = meetings.map(meeting => ({
        ...
        description: meeting.notes || 'No description available'
      }))
          ...
          <div className="sticky top-0 z-10 bg-black/80 backdrop-blur-sm border-b border-zinc-800 px-6 py-4">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-zinc-400 text-sm mt-1">Manage and view all your meetings</p>
              </div>
              <Button 
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-zinc-400">{meeting.description}</p>
                          </div>
