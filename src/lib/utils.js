 ...
 * @param {string} url The meeting URL (e.g., https://meet.google.com/xxx-xxxx-xxx)
 * @returns {{platform: string, nativeMeetingId: string}} Object containing platform and nativeMeetingId
 */
